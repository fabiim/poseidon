...
package net.floodlightcontroller.devicemanager.normal;
...
import static net.floodlightcontroller.devicemanager.normal.DeviceManagerImpl.DeviceUpdate.Change.*;
...
IFlowReconcileListener, IInfoProvider, IHAListener {
    ...
    protected static class DeviceUpdate {
        ...
        public DeviceUpdate(IDevice device, Change delete,
