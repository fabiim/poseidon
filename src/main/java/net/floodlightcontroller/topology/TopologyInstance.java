...
public class TopologyInstance  implements Serializable{
    ...
    public TopologyInstance(Map<Long, ? extends Set<Short>> switchPorts,
    ...
    public TopologyInstance(Map<Long, ? extends Set<Short>> switchPorts,
                            ...
                            Map<NodePortTuple, ? extends Set<Link>> switchPortLinks,
                            Set<NodePortTuple> broadcastDomainPorts,
                            Set<NodePortTuple> tunnelPorts){

        // copy these structures
        this.switches = new HashSet<Long>(switchPorts.keySet());
        this.switchPorts = (Map<Long, Set<Short>>) switchPorts;
        this.blockedPorts = new HashSet<NodePortTuple>(blockedPorts);
        this.switchPortLinks = new HashMap<NodePortTuple, Set<Link>>();
        this.switchPortLinks = (Map<NodePortTuple, Set<Link>>) switchPortLinks; 
        this.broadcastDomainPorts = new HashSet<NodePortTuple>(broadcastDomainPorts);
    ...
    public Route getRoute(long srcId, long dstId, long cookie) {
        RouteId id = new RouteId(srcId, dstId);
        Route result = null;
    ...
    public Set<Long> getSwitchesInOpenflowDomain(long switchId) {
        Cluster c = switchClusterMap.get(switchId);
        if (c == null) {
