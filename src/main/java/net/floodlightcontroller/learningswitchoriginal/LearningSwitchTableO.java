...
public class LearningSwitchTableO extends ServerResource {
    protected static Logger log = LoggerFactory.getLogger(LearningSwitchTableO.class);
    ...
    public Map<String, List<Map<String, Object>>> getSwitchTableJson() {
        ILearningSwitchServiceO lsp = 
                (ILearningSwitchServiceO)getContext().getAttributes().
                    get(ILearningSwitchServiceO.class.getCanonicalName());
