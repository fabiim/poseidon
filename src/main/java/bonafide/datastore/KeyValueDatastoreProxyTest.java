...
public class KeyValueDatastoreProxyTest {
	...
	/**
	 * Test method for {@link bonafide.datastore.KeyValueDatastoreProxy#put(java.lang.String, byte[], byte[])}.
	 */
	@Test
	public void testPut() {
		String tableName = "put";
		ds.createTable(tableName);
		byte[] val = ds.put(tableName,key_1, value_1);
		...
		assertArrayEquals(val, value_1); // previous value was value_1 
		Assert.assertArrayEquals(ds.get(tableName,key_1), value_2); // should get value 2 
	}


	/**
	 * Test method for {@link bonafide.datastore.KeyValueDatastoreProxy#insert(java.lang.String, byte[], byte[])}.
	 */
	@Test
	public void testInsert() {
		...
		assertTrue(inserted);
		assertArrayEquals(ds.get(tableName, key_1), value_1); 
		inserted = ds.insert(tableName,key_1, value_2);
		assertTrue(inserted); 
		assertArrayEquals(ds.get(tableName, key_1), value_2); //value has been replaced.  
	}

	/**
	 * Test method for {@link bonafide.datastore.KeyValueDatastoreProxy#get(java.lang.String, byte[])}.
	 */
	@Test
	public void testGet() {
		String tableName = "get";
		ds.createTable(tableName);
		byte[] val = ds.get(tableName, key_1);
		...
		assertArrayEquals(val, value_1); 
	}
	

	/**
	 * Test method for {@link bonafide.datastore.KeyValueDatastoreProxy#remove(java.lang.String, byte[])}.
	 */
	@Test
	public void testRemoveStringByteArray() {
		...
		ds.createTable(tableName);
		ds.put(tableName, key_1, value_1);
		byte[] val =ds.remove(tableName, key_1);
		assertNotNull(val);
		assertArrayEquals(val, value_1); 
	}
	
	/**
	 * Test method for {@link bonafide.datastore.KeyValueDatastoreProxy#replace(java.lang.String, byte[], byte[], byte[])}.
	 */
	@Test
	public void testReplace() {
		...
		assertArrayEquals(ds.get(tableName, key_1), value_2); 
		assertTrue(ds.replace(tableName, key_1, value_2, value_1));
		assertArrayEquals(ds.get(tableName, key_1), value_1);
	}

	/**
	 * Test method for {@link bonafide.datastore.KeyValueDatastoreProxy#remove(java.lang.String, byte[], byte[])}.
	 */
	@Test
	...
	/**
	 * Test method for {@link bonafide.datastore.KeyValueDatastoreProxy#putIfAbsent(java.lang.String, byte[], byte[])}.
	 */
	@Test
	public void testPutIfAbsent() {
		...
		assertArrayEquals(ds.get(tableName, key_1), value_1); 
		assertArrayEquals(ds.putIfAbsent(tableName, key_1, value_2), value_1);
		assertArrayEquals(ds.putIfAbsent(tableName, key_1, value_2), value_1);
	}

	/**
	 * Test method for {@link bonafide.datastore.TableDataStoreProxy#clear()}.
	 */
	@Test
	...
	/**
	 * Test method for {@link bonafide.datastore.TableDataStoreProxy#createTable(java.lang.String)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link bonafide.datastore.TableDataStoreProxy#createTable(java.lang.String, long)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link bonafide.datastore.TableDataStoreProxy#removeTable(java.lang.String)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link bonafide.datastore.TableDataStoreProxy#containsTable(java.lang.String)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link bonafide.datastore.TableDataStoreProxy#clear(java.lang.String)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link bonafide.datastore.TableDataStoreProxy#isEmpty(java.lang.String)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link bonafide.datastore.TableDataStoreProxy#size(java.lang.String)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link bonafide.datastore.TableDataStoreProxy#containsKey(java.lang.String, byte[])}.
	 */
	@Test
	...
	/**
	 * Test method for {@link bonafide.datastore.TableDataStoreProxy#getAndIncrement(java.lang.String, java.lang.String)}.
	 */
	@Test
	public void testGetAndIncrement() {
		...
		assertTrue(Arrays.equals(ds.get(tableName, "1".getBytes()), value_1));
	}
	...
	public void testValues(){
		...
		ds.put(tableName, key_1, value_1); 
		ds.put(tableName, key_2, value_2); 
		Collection<byte[]> maps = ds.values(tableName);
		
		assertSame(maps.size(), 2);
		boolean c1=false,c2=false;
		for (byte[] m : maps){
			if (Arrays.equals(m, value_1)){
				c1 = true;
			}
			else if (Arrays.equals(m, value_2)){
				c2 = true;
			}
		}
		if (!(c1 && c2)){
