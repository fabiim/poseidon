...
class TestEntityClass implements IEntityClass , Serializable{
    	/**
	 * 
	 */
 ...
 *
 */
public class MockFlexEntityClassifier extends DefaultEntityClassifier implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
