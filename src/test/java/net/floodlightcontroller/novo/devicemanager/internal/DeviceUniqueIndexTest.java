...
public class DeviceUniqueIndexTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        super.setUp();
        mapserver.MapSmart.main(new String[1]);
        ds = new Datastore(); 
        ...
        d1 = new Device(Long.valueOf(1), null, null, null,
                        d1Entities, null);
        
        // e2 and e2 alt match in MAC and VLAN
        e2 = new Entity(2L, (short)2, 2, 2L, 2, new Date());
        e2alt = new Entity(2L, (short)2, null, null, null, null);
    ...
    public void testDeviceUniqueIndex() {
        ...
        Device d4 = new Device( 4L, null, null, null,
